...
const Details = ({ history, location, match }) => {
  ...
  }, [dispatch, updatedContact, edited, id]);
          ...
          <DIV>
            <div style={{ display: "block" }}>
              {edit ? (
                ...
                <div>
                  <PlaceHolder>
                    <Icon className="fas fa-user"></Icon>Name: {contact.Name}
                  </PlaceHolder>
                  <PlaceHolder>
                    <Icon className="fas fa-envelope"></Icon>Email:{" "}
                    {contact.Email}
                  </PlaceHolder>
                  <PlaceHolder>
                    <Icon className="fas fa-phone-alt"></Icon>Phone:{" "}
                    {contact.Phone}
                  </PlaceHolder>
                </div>
              )}
